...
<body>
    ...
    <div class="main">
        ...
        <div class="stats">
            ...
            <div class="stat-card">$<?= number_format($revenue, 2) ?><br>Total Revenue</div>
            <div class="stat-card"><?= $topProduct ? $topProduct['name'] . ' (' . $topProduct['rating'] . ')' : 'N/A' ?><br>Top Product</div>
