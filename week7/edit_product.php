...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $stmt = $conn->prepare("UPDATE products SET name=?, brand=?, category=?, price=?, stock=?, rating=? WHERE id=?");
    $stmt->bind_param("sssdisi", $name, $brand, $category, $price, $stock, $rating, $id);
    if($stmt->execute()){
