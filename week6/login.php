...
<head>
    ...
    button {
        ...
        background: #00d4ff; font-weight: bold; cursor: pointer; color: #1a1a2e;
    }
    button:hover { background: #00b4dc; }
    .error { color: #ff4d4d; font-size: 0.9em; margin-top: 5px; }
    a { color: #00d4ff; display: block; margin-top: 12px; }
    </style>
</head>
<body>
    <div class="login-box">
